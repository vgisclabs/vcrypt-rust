//! MKV128-128-auth tag tests

#[macro_use]
mod common;

use self::common::TestVector;
use mkv128_gcm::aead::{generic_array::GenericArray, Aead, AeadInPlace, KeyInit, Payload};
use mkv128_gcm::Mkv128128Gcm;
use hex_literal::hex;
...
tests!(Mkv128128Gcm, TEST_VECTORS);

// Test vectors from Wycheproof
aead::new_test!(wycheproof, "wycheproof-128", Mkv128128Gcm);
