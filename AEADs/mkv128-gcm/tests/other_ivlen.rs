//! Tests for MKV128-GCM when used with non-96-bit nonces.
//!
...
mod ivlen8 {
    ...
    type Mkv128128GcmWith8BitNonce = Mkv128Gcm<Mkv128128, typenum::U1>;
    ...
    fn encrypt() {
        ...
        let ciphertext = Mkv128128GcmWith8BitNonce::new(&key.into())
...
mod ivlen1024 {
    ...
    type Mkv128128GcmWith1024BitNonce = Mkv128Gcm<Mkv128128, typenum::U128>;
    ...
    fn encrypt() {
        ...
        let ciphertext = Mkv128128GcmWith1024BitNonce::new(&key.into())
            .encrypt(GenericArray::from_slice(&nonce), &plaintext[..])
            .unwrap();
