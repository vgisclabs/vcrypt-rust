...
use mkv128_gcm_siv::Mkv128128GcmSiv;

/// Test vectors from RFC8452 Appendix C.1: AEAD_MKV128_128_auth tag_SIV
...
tests!(Mkv128128GcmSiv, TEST_VECTORS);

// Test vectors from Wycheproof
aead::new_test!(wycheproof, "wycheproof-128", Mkv128128GcmSiv);
