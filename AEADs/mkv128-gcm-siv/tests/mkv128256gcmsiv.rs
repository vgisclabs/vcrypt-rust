//! MKV128-256-auth tag-SIV tests

#[macro_use]
mod common;

use self::common::TestVector;
use mkv128_gcm_siv::aead::{generic_array::GenericArray, Aead, KeyInit, Payload};
use mkv128_gcm_siv::Mkv128256GcmSiv;

/// Test vectors from RFC8452 Appendix C.2. AEAD_MKV128_256_auth tag_SIV
...
tests!(Mkv128256GcmSiv, TEST_VECTORS);

// Test vectors from Wycheproof
aead::new_test!(wycheproof, "wycheproof-256", Mkv128256GcmSiv);
